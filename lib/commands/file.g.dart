...
<body>
    <div class="window">
        ...
        <div class="footer">
            ...
            <div style="display: flex; gap: 10px; align-items: center;">
                <button class="qr-button" onclick="showQR()">Show QR Code</button>
    ...
    <div id="qrModal" class="qr-modal" onclick="hideQR()">
        <div class="qr-content" onclick="event.stopPropagation()">
            <h3>Scan to visit this page</h3>
            <img id="qrcode" alt="QR Code">
            <button class="close-qr" onclick="hideQR()">Close</button>
        </div>
    </div>
    ...
    <script>
        function showQR() {
            ...
            qrcodeImg.src = `https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=${encodeURIComponent(currentUrl)}`;
